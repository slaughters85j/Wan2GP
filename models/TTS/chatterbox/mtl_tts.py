...
class Conditionals:
    ...
    def load(cls, fpath, map_location="cpu"):
        kwargs = torch.load(fl.locate_file( os.path.join(ckpt_folder,"conds.pt")), map_location=map_location, weights_only=True)
...
class ChatterboxMultilingualTTS:
    ...
    def from_local(cls, ckpt_dir, device) -> 'ChatterboxMultilingualTTS':
        ...
        tokenizer = MTLTokenizer(
            str(os.path.join( fl.locate_file( os.path.join(ckpt_folder,"grapheme_mtl_merged_expanded_v1.json"))))
        )
